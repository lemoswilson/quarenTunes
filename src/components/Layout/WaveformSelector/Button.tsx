...
const Button: React.FC<{ selected: boolean }> = ({ selected }) => {
    ...
    return (
        <svg height={'0.75rem'} width={'0.75rem'} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="9.55 10.65 12 12" preserveAspectRatio={'xMaxYMid slice'}>
