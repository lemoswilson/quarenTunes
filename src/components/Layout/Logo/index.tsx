...
// <svg style={{width: '3vw', height: '3vw'}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28.72 43.08">
const Logo: React.FC<{className?: string, style?: React.CSSProperties}> = ({ className, style }) => {
    return (
        <svg className={className} style={style} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28.72 43.08">
            <title>logo</title>
