...
export default ContinuousIndicator;
        ...
        //                     <g>
        //                         <g>
        //                             <circle cx="33.64" cy="18.96" r="4.23" style={{ fill: "url(#a)" }} transform={rotatek} /> {/* smaller 1 */}
        //                             <circle cx="33.64" cy="18.96" r="4.23" style={{ fill: "url(#a)" }} transform={rotatek} /> {/* smaller 1 */}
        //                         </g>
        //                         <circle cx="33.64" cy="18.96" r="2.97" style={{ fill: "url(#a)" }} transform={rotatek} /> {/* smaller 2 */}
        //                     </g>
        //                 </g>
        //                 <g>
