        ...
        <svg ref={svgRef} className={`${styles.menuButton} ${className}`} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 22 22">
            ...
            <g style={{isolation: "isolate"}}>
                ...
                <g>
                    ...
                    <path d="M17.34,3.87v.57A1.56,1.56,0,0,1,15.78,6H4.09A1.57,1.57,0,0,1,2.52,4.44V3.87A1.57,1.57,0,0,1,4.09,2.3H15.78A1.56,1.56,0,0,1,17.34,3.87Z" className={styles.color}/>
                </g>
                <g>
                    ...
                    <path d="M17.34,9v.57a1.56,1.56,0,0,1-1.56,1.56H4.09A1.56,1.56,0,0,1,2.52,9.56V9A1.57,1.57,0,0,1,4.09,7.42H15.78A1.56,1.56,0,0,1,17.34,9Z" className={styles.color}/>
                </g>
                <g>
                    ...
                    <path d="M17.34,14.11v.57a1.56,1.56,0,0,1-1.56,1.56H4.09a1.56,1.56,0,0,1-1.57-1.56v-.57a1.57,1.57,0,0,1,1.57-1.57H15.78A1.56,1.56,0,0,1,17.34,14.11Z" className={styles.color}/>
                </g>
                </g>
            </g>
        </svg>
