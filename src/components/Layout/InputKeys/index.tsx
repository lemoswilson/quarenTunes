            ...
            <div className={styles.topWrapper}>
                ...
                <div className={styles.noteLength}>
                    ...
                    <div className={styles.select}>
                        ...
                        <Dropdown renamable={false} keyValue={subdivisionOptions.map(value => [value, value])} small={true} className={''} selected={selectedNoteLength()} select={(length) => { setPatternNoteLength(length) }}></Dropdown>
                        {/* dropdown here */}
                    </div>
                </div>
            </div>
