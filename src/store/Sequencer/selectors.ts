...
export const activePattLengthSelector = (activePatt: number) => (state: RootState) => { 
    return state.sequencer.present.patterns[activePatt].patternLength 
}
export const selectTrkPattLenSelector = (activePatt: number, selectedTrkIndex: number) => (state: RootState) => { 
...
export const pattNoteLenSelector = (index: number) => (state: RootState) => {
